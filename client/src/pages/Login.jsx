        ...
        <div className="min-h-screen mt-[-47%] pt-35 bg-black flex items-center justify-center p-4 ">
          <div className="backdrop-blur-lg bg-gradient-to-b from-[#fff3e0] to-[#fbe8d3] border border-[#c49b63] shadow-xl rounded-2xl p-8 w-full max-w-md text-[#8b1f1f]">
            ...
            <form className="space-y-5" onSubmit={formSubmitKro}>
              <div>
                <label
                  className="block mb-1 text-sm font-medium text-[#8b1f1f]"
                  htmlFor="email"
                >
                  Email
                </label>
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg bg-white border border-[#c49b63] placeholder-[#c49b63]/70 text-[#8b1f1f] focus:outline-none focus:ring-2 focus:ring-[#8b1f1f]"
              ...
              <button
                type="submit"
                className="w-full py-2 rounded-lg bg-[#8b1f1f] hover:bg-[#a02828] text-white transition-colors font-medium shadow-md"
              >
                Sign In
              </button>
              <div className="text-center">
                ...
                <Link
                  to={"/register"}
                  className="text-[#c49b63] font-bold hover:text-[#8b1f1f]"
                >
                  Register
                </Link>
              </div>
