...
const ContactViewModal = ({ isOpen, onClose, Query }) => {
  ...
  const statusConfig = {
    Pending: {
      color: "bg-[#fffbe6] text-[#a27300] border-[#ffecb3]",
      icon: FaClock,
    },
    Resolved: {
      color: "bg-[#e6ffe6] text-[#2e7d32] border-[#b9f6ca]",
      icon: FaCheckCircle,
    },
    Rejected: {
      color: "bg-[#ffe6e6] text-[#b71c1c] border-[#ffcdd2]",
      icon: FaExclamationCircle,
    },
  };
  ...
  return (
    ...
    >
      <div
        ...
        onClick={(e) => e.stopPropagation()}
      >
        <div className="bg-gradient-to-r from-[#8b1f1f] to-[#c66b3d] rounded-t-2xl p-6 text-white">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center text-xl font-bold">
                {query.name?.charAt(0)?.toUpperCase()}
              ...
              <div>
                <h3 className="text-2xl font-bold">Query Details</h3>
                <p className="text-[#fbe8d3]">Customer Support Ticket</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <span
        ...
        <div className="p-6">
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="space-y-4">
              <div className="bg-[#fce7d3] rounded-lg p-4">
                <label className="block text-sm font-semibold text-[#6c3d0c] mb-1">
                  Customer Name
                </label>
                <p className="text-lg font-medium text-[#8b1f1f]">
                  {query.name}
                </p>
              </div>
              ...
              <div className="bg-[#fce7d3] rounded-lg p-4">
                ...
                <p className="text-[#5e2c04]">{query.email}</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-[#fce7d3] rounded-lg p-4">
                ...
                <p className="text-[#5e2c04]">{query.phone}</p>
              </div>
              ...
              <div className="bg-[#fce7d3] rounded-lg p-4">
                ...
                <p className="text-[#5e2c04]">{query.subject}</p>
              </div>
            </div>
          </div>

          <div className="mb-6">
            <div className="bg-[#fff8e1] border-l-4 border-[#ffcc80] rounded-lg p-4">
              <label className="block text-sm font-semibold text-[#8b1f1f] mb-2">
                Customer Message
              </label>
              <p className="text-[#5e2c04] leading-relaxed">{query.message}</p>
            </div>
          </div>

          <div className="border-t-2 border-[#c49b63] pt-6">
            <h4 className="text-lg font-bold text-[#8b1f1f] mb-4 flex items-center gap-2">
              <FaEdit className="text-[#8b1f1f]" />
              Admin Response
            </h4>

            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-[#6c3d0c] mb-2">
                  Update Status
                </label>
                <select
                  name="status"
                  value={updateData.status}
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 border-2 border-[#c49b63] rounded-lg focus:border-[#8b1f1f] focus:ring-2 focus:ring-[#fbe8d3] outline-none transition-all"
                  disabled={Query.status !== "Pending"}
                >
                  <option value="Pending">🟡 Pending</option>
                  <option value="Resolved">🟢 Resolved</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Write your response to the customer..."
                  rows="4"
                  className="w-full px-4 py-3 border-2 border-[#c49b63] rounded-lg focus:border-[#8b1f1f] focus:ring-2 focus:ring-[#fbe8d3] outline-none transition-all resize-none"
                  disabled={Query.status !== "Pending"}
                />
              </div>
              ...
              <div className="flex gap-3 pt-4">
                <button
                  onClick={onClose}
                  className="flex-1 px-6 py-3 border-2 border-[#c49b63] text-[#6c3d0c] rounded-lg hover:bg-[#fbe8d3] transition-colors font-medium"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-[#8b1f1f] to-[#c66b3d] text-white rounded-lg hover:from-[#731212] hover:to-[#b85a2d] disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
                      <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
